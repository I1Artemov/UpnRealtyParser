...
import AnyRentFlatReadConnected from './AnyRentFlatReadConnected/anyRentFlatReadConnected.jsx';
                            ...
                            <Content style={{ margin: '0 16px' }}>
                                ...
                                <main>
                                    <Switch>
                                        ...
                                        <Route exact path="/rentflat/:id" render={(props) => <AnyRentFlatReadConnected siteName="upn" {...props} />} />
                                        <Route exact path="/n1rentflat/:id" render={(props) => <AnyRentFlatReadConnected siteName="n1" {...props} />} />
